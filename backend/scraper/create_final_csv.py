...
def create_final_csv():
    ...
    required_fieldnames = ['news_website', 'url', 'original_language', 'owner', 'city', 'canton', 'occurrence']
    ...
    print(f"   - ✅ Proper CSV schema: news_website,url,original_language,owner,city,canton,occurrence")
